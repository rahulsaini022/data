...
Route::get('/basic_email', 'HomeController@basic_email')->name('basic_email');
...
Route::group(['middleware' => ['auth','role:super admin']], function() {
    ...
    Route::post('attorneytableactive/index-filtering', 'AttorneyTableActiveController@Filtering');
