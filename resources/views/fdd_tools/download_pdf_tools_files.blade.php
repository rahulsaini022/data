...
<div class="container">
    <div class="row justify-content-center attorney-dashboard download-directory-listing-main">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><strong>{{ __('FDD PDF Tools Processed Files Downloads') }}</strong>
                ...
                <div class="card-body table-sm table-responsive">
                    ...
                    <table class="table table-bordered downloads-table">
                      ...
                      @foreach($files_data as $file_data)
                        @if(strpos($file_data->getFilename(), 'FDDSQ') == true || strpos($file_data->getFilename(), 'FDDSC') == true|| strpos($file_data->getFilename(), 'FDDFX') == true)
