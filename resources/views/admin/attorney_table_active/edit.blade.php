        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! Form::model($attorneytableactive, ['method' => 'PATCH','route' => ['attorneytableactive.update', $attorneytableactive->id], 'id'=>'edit_attorneytableactive_form', 'autocomplete'=>'off']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="selected_state" name="" value="{{$attorneytableactive->registration_state_id}}" style="display: none;">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select id="sufname" name="sufname" class="form-control">
                                    ...
                                    <option value="Sr." <?php if(isset($attorneytableactive->sufname) && $attorneytableactive->sufname=='Sr.'){ echo "selected"; } ?>>Sr.</option>
                                    <option value="Jr." <?php if(isset($attorneytableactive->sufname) && $attorneytableactive->sufname=='Jr.'){ echo "selected"; } ?>>Jr.</option>
                                    <option value="I" <?php if(isset($attorneytableactive->sufname) && $attorneytableactive->sufname=='I'){ echo "selected"; } ?>>I</option>
                                    <option value="II" <?php if(isset($attorneytableactive->sufname) && $attorneytableactive->sufname=='II'){ echo "selected"; } ?>>II</option>
                                    <option value="III" <?php if(isset($attorneytableactive->sufname) && $attorneytableactive->sufname=='III'){ echo "selected"; } ?>>III</option>
                                    <option value="IV" <?php if(isset($attorneytableactive->sufname) && $attorneytableactive->sufname=='IV'){ echo "selected"; } ?>>IV</option>
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" id="atgen-m" class="gender-input" name="gender" value="M" required="" <?php if(isset($attorneytableactive->gender) && $attorneytableactive->gender=='M'){ echo "checked"; } ?>>
                                <label for="atgen-m">M</label>&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="atgen-f" class="gender-input" name="gender" value="F" <?php if(isset($attorneytableactive->gender) && $attorneytableactive->gender=='F'){ echo "checked"; } ?>>
                                <label for="atgen-f">F</label>&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="atgen-n" class="gender-input" name="gender" value="N" <?php if(isset($attorneytableactive->gender) && $attorneytableactive->gender=='N'){ echo "checked"; } ?>>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Admission Date" class="form-control hasDatepicker" required="required" name="admissiondate" type="text" value="<?php if(isset($attorneytableactive->admissiondate)){ echo date('m/d/Y', strtotime($attorneytableactive->admissiondate));} ?>">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Birth Date" class="form-control hasDatepicker" name="birthdate" type="text" value="<?php if(isset($attorneytableactive->birthdate)){ echo date('m/d/Y', strtotime($attorneytableactive->birthdate));} ?>">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="" id="firm_state_input" value="{{ $attorneytableactive->firm_state }}">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="" id="firm_city_input" value="{{ $attorneytableactive->firm_city }}">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="" id="firm_county_input" value="{{ $attorneytableactive->county_id }}">
...
$(document).ready(function () {
    ...
    $('#edit_attorneytableactive_form').validate({
        rules: {
            firm_telephone: {
