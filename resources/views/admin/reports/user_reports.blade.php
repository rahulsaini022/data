            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12" id="get_users_by_day_chart_div">
                        <div class="text-center border-bottom border-info"><h5>Daily User Report</h5></div>
                            ...
                            $.ajax({
                                ...
                                success: function(data){
                                    if(data==null || data=='null'){
                                            ...
                                            var get_users_by_day_chart_data = new Chart(daily, {
                                            type: 'line',
                                            data: {
                                                labels: data.label,
                                                datasets: [{
                    ...
                    <div class="col-md-12 p-5" id="get_users_by_week_chart_div">
                        <div class="text-center border-bottom border-info"><h5>Weekly User Report</h5></div>
