...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Advertiser Reports</div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <div class="col-md-12" id="get_advertisers_by_day_chart_div">
                            <div class="text-center border-bottom border-info">
                                <h5>Daily Advertiser Report</h5>
                            </div>
                            <canvas id="get_advertisers_by_day_chart_data" width="400" height="400"></canvas>
                            <script>
                                ...
                                var daily = document.getElementById('get_advertisers_by_day_chart_data');
                                daily.height = 300;
                                $.ajax({
                                    url: "{{ route('get_advertisers_by_day_chart_data') }}",
                                    method: "GET",
                                    dataType: 'json',
                                    success: function(data) {
                                        if (data == null || data == 'null') {} else {
                                            var get_advertisers_by_day_chart_data = new Chart(daily, {
                                                type: 'line',
                                                data: {
                                                    labels: data.label,
                                                    datasets: [{
                        ...
                        <div class="col-md-12 p-5" id="get_advertisers_by_week_chart_div">
                            <div class="text-center border-bottom border-info">
                                <h5>Weekly advertiser Report</h5>
                            </div>
                            <canvas id="get_advertisers_by_week_chart_data" width="400" height="400"></canvas>
                            <script>
                                ...
                                var backgroundBorderColor = '#36a2eb';
                                var weekly = document.getElementById('get_advertisers_by_week_chart_data');
                                weekly.height = 330;
                                $.ajax({
                                    url: "{{ route('get_advertisers_by_week_chart_data') }}",
                                    method: "GET",
                                    dataType: 'json',
                                    success: function(data) {
                                        if (data == null || data == 'null') {} else {
                                            var get_advertisers_by_week_chart_data = new Chart(weekly, {
                                                type: 'line',
                                                data: {
                                                    labels: data.label,
                                                    titles: data.title,
