        ...
        <div class="row justify-content-center dynamic-page-main">
                    ...
                    <div class="card-body">
                        ...
                        <div class="dynamic-page-content">
                            ...
                            <div>
                               ...
                               @if(str_replace(url('/'), '', url()->previous()) == '/pages')
                                     <div class="col-sm-4"><a class="btn btn-info mb-1 pull-left "
                                                    href="{{ route('pages.index') }}">Back</a></div>
                                    @else
                                @if ($page->slug == 'how-fdd-can-save-you-money')
                                    <div class="row mt-4">
                                        <div class="col-sm-6"><a class="btn btn-info mb-1 new-btn pull-left"
                                                href="{{ route('refer_an_attorney_who_uses_fdd') }}">Please refer an
                                                Attorney to me <br> who uses First Draft Data</a></div>
                                        <div class="col-sm-6"><a class="btn btn-info mb-1 new-btn pull-right"
                                                href="{{ route('inform_my_attorney_to_use_fdd') }}">Please inform my
                                                Attorney <br> I want them to start using First Draft Data</a></div>
                                    </div>
                                @else
                                   
                                        <div class="row mt-4">
                                            <div class="col-sm-4"><a class="btn btn-info mb-1 pull-left new-back-btn"
                                                    href="{{ route('home') }}">Back</a></div>
                                            <div class="col-sm-4 text-center">
                                                @if ($page->slug == 'what-we-offer')
                                                    <a class="btn btn-info mb-1 new-btn"
                                                        href="{{ route('dynamic_page', 'pricing') }}">Pricing</a>
                                                @endif
                                                @if ($page->slug == 'pricing')
                                                    <a class="btn btn-info mb-1 new-btn"
                                                        href="{{ route('dynamic_page', 'what-we-offer') }}">What We Offer</a>
                                                @endif
                                            </div>
                                            <div class="col-sm-4"><a class="btn btn-info mb-1 new-btn pull-right"
                                                    href="{{ route('demo') }}">Demo</a></div>
                                        </div>
                                    @endif
                                @endif
                            </div>
            ...
            <div class="modal fade fdd-documents-list-modal" id="myModal" role="dialog" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-left fdd-documents-list"
            ...
            <script type="text/javascript">
                function openModal(package_id) {
                    $(".fdd-documents-list").html(
                        '<div class="loader" id="loader-6"><span></span><span></span><span></span><span></span></div>');
