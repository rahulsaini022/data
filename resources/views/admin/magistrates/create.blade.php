...
<div class="container">
    <div class="row justify-content-center attorney-dashboard">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><strong>{{ __('Create New Magistrate') }}</strong>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <!-- {!! Form::number('court_id', null, array('placeholder' => 'Magistrate Court Id','class' => 'form-control', 'readonly')) !!} -->
...
$(document).ready(function () {
    ...
    $('#create_magistrate_form').validate({
        rules: {
            mag_phone: {
