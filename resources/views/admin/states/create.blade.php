...
<div class="container">
    <div class="row justify-content-center attorney-dashboard">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><strong>{{ __('Create New State') }}</strong>
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(array('route' => 'states.store','method'=>'POST')) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('state_abbreviation', null, array('placeholder' => 'State Abbreviation','class' => 'form-control')) !!}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" id="active-1" class="active-input" name="active" value="1" required="">
