...
<div class="container">
    <div class="row justify-content-center attorney-dashboard">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><strong>{{ __('All Payments') }}</strong>
                ...
                <div class="card-body table-sm table-responsive">
                    ...
                    <div class="row mb-4 p-4">
                        ...
                        <div class="col-sm-10 text-right">
                            <a href="{{ route('show_all_payments') }}" class="btn btn-success mb-1">All</a>

                            <a class="btn btn-success mb-1" href="{{ route('get_current_month_all_payments') }}"> This Month
                            </a>

                            <a class="btn btn-success mb-1" href="{{ route('get_month_based_all_payments',['months'=>'3']) }}"> Last 3 Month
                            </a>

                            <a class="btn btn-success mb-1" href="{{ route('get_month_based_all_payments',['months'=>'6']) }}"> Last 6 Month
                            </a>
                        </div>
                        <div class="col-sm-12 mt-4 payment-filter-form-main">
                            <form id="custom-date-form" action="{{ route('get_date_based_all_payments') }}" method="POST" autocomplete="off">
