...
<div class="container">
    <div class="row justify-content-center attorney-dashboard">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><strong>{{ __('All User Credits Payments') }}</strong>
                ...
                <div class="card-body table-sm table-responsive">
                    ...
                    <div class="row mb-4 p-4">
                        ...
                        <div class="col-sm-10 text-right">
                            <a href="{{ route('show_user_credits_payments') }}" class="btn btn-success mb-1">All</a>

                            <a class="btn btn-success mb-1" href="{{ route('get_current_month_user_credits_payments') }}"> This Month
                            </a>

                            <a class="btn btn-success mb-1" href="{{ route('get_month_based_user_credits_payments',['months'=>'3']) }}"> Last 3 Month
                            </a>

                            <a class="btn btn-success mb-1" href="{{ route('get_month_based_user_credits_payments',['months'=>'6']) }}"> Last 6 Month
                            </a>
                        </div>
                        <div class="col-sm-12 mt-4 payment-filter-form-main">
                            <form id="custom-date-form" action="{{ route('get_date_based_user_credits_payments') }}" method="POST" autocomplete="off">
                    ...
                    <table class="table table-bordered user-credits-payments-table mt-4 payments-history-table">
                      <thead>
                        <tr>
...
<script>
  ...
  $(document).ready( function () {
    $('.user-credits-payments-table').DataTable({
        pageLength: 50,
        responsive: true
    });
  } );
