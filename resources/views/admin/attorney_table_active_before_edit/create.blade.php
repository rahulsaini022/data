        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(array('route' => 'attorneytableactivebeforeedit.store','method'=>'POST', 'id'=>'create_attorneytableactivebeforeedit_form', 'autocomplete'=>'off')) !!}
...
$(document).ready(function () {
    ...
    $('#create_attorneytableactivebeforeedit_form').validate({
        rules: {
            firm_telephone: {
