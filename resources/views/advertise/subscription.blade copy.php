            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row"> 
                     ...
                     <form id="payment-form"  onkeyup="return validateForm()" action="{{route('advertise.subscribe') }}" method="POST" enctype="multipart/form-data" >
                                    @csrf
                            ...
                            <div class="form-group col-md-6"><div class="col-md-8" ><label for='price'>Price *</label><input min="1" oninput="validity.valid||(value='');" onKeyPress="if(this.value.length==8) return false;" id='price' type="number" required name="AD_price" class="form-control"></div></div>
                        ...
                        <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="advertiser_services_id" name="advertiser_services_id[]" value="{{ $v->id }}"><label for="Oral_Depositions" class="form-check-label">{{ $v->name }}</label><br/>
                        ...
                        @endforeach
                             ...
                             <div class="form-group col-md-6 "><div class="col-md-8" > <label for='image'>Image</label><br><input type="file" id='image' name="images[]"  accept="image/*" onchange="imageValidate()" class="form-custom-file"  multiple><div id="dvPreview"></div></div><span id='spanFileName' class="text-danger"></span></div></div>
                            <div class="form-group col-md-12 "><label for='desc'>Description</label><textarea id='desc' rows=4 class="form-control"   name="description" ></textarea></div> 
