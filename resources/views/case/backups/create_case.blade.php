                        ...
                        <div class="row setup-content form-group" id="step-1">
                            ...
                            <div class="col-md-12 to_be_filed_new_inputs currently_filed_inputs number_third_party_complaint_div">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <input id="number_top_third_parties" type="number" class="form-control number_third_party_complaint_inputs" name="number_top_third_parties" value="1" min="1" max="6">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <input id="number_bottom_third_parties" type="number" class="form-control number_third_party_complaint_inputs" name="number_bottom_third_parties" value="1" min="1" max="6">
                                    </div>
                                </div>
                            </div>
