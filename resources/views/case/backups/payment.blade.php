...
<div class="container">
    <div class="row justify-content-center casepage_payment_outer">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><strong>{{ __('Payment') }}</strong></div>
                <div class="card-body">
                    ...
                    <div class="row"> 
                        <div class="col-md-12" align="center">
                            ...
                            <p>To Complete Registration of your Case please complete the Payment Process.</p>
                        </div>
                        <?php 
                        ...
                        $i=0; $j=0; $total_packages=count($case_packages); ?>  
                            ...
                            @endif    
                                ...
                                @endif
                                    <div class="package-title-div">
                                        <h4>{{ $case_package->package_title}} (${{ $case_package->package_price }})</h4>
                                    </div>
                        ...
                        <div class="cc-payment-outer payment-cc-main" style="display: none;">
                            ...
                            <form id="payment-form" action="{{route('cases.makepayment') }}" method="POST" style="display: none;">
                                @csrf
...
<script>
    ...
    function selectPackage(package_name, package_price, id) {
        ...
        $('#package_price, #package_price_input').val(package_price);
        $('#package_id').val(id);
