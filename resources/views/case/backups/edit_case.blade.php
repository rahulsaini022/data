                    ...
                    <form id="multistep_case_form" method="POST" action="{{route('cases.update_case',['id'=>$case_data->id])}}" autocomplete="off">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12 to_be_filed_new_inputs currently_filed_inputs">
                                ...
                                <div class="col-md-6">
                                    <label for="number_top_party_type" class="col-md-4 col-form-label text-md-left">Number of <span class="number_of_top_party_type_span">Clients</span>*</label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12 to_be_filed_new_inputs currently_filed_inputs">
                                ...
                                <div class="col-md-6">
                                    <label for="number_bottom_party_type" class="col-md-4 col-form-label text-md-left">Number of <span class="number_bottom_party_type_span">Opponents</span>*</label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-12 to_be_filed_new_inputs currently_filed_inputs number_third_party_complaint_div">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <input id="number_top_third_parties" type="number" class="form-control number_third_party_complaint_inputs" name="number_top_third_parties" value="<?php if(isset($case_data->number_top_third_parties)){ echo $case_data->number_top_third_parties; } ?>" min="1" max="6">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <input id="number_bottom_third_parties" type="number" class="form-control number_third_party_complaint_inputs" name="number_bottom_third_parties" value="<?php if(isset($case_data->number_bottom_third_parties)){ echo $case_data->number_bottom_third_parties; } ?>" min="1" max="6">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <label for="short_caption" class="col-md-4 col-form-label text-md-left">Short Caption*</label>
                                    <div class="col-md-8">
                                        <input id="short_caption" type="text" class="form-control" name="short_caption" autofocus="" value="<?php if(isset($case_data->short_caption)){ echo $case_data->short_caption; } ?>" required>
                                    </div>
                                </div>
                            </div>
    ...
    $('#multistep_case_form').validate({});
       ...
       $(".hasDatepickerFinal").datepicker({
        ...
        $('#case_state').on('change', function(){
            ...
            $('.case_judge_name_inputs, .case_magistrate_name_inputs, #other_case_type').prop('required', false);
            $('.case-types-div').empty();
            $('.case_judge_magistrate_name_inputs_div, .case-types-div, .no-case-types, .case_type_other_div_main').hide();
            var id=this.value;
        ...
        $('#case_division').on('change', function(){
            ...
            $('.case_judge_name_inputs, .case_magistrate_name_inputs').val('');
            $('.case_judge_name_inputs, .case_magistrate_name_inputs, #case_sets, #other_case_type').prop('required', false);
            $('.case-types-div').empty();
            $('.case_judge_magistrate_name_inputs_div, .case-types-div, .no-case-types, .case_sets_div, .case_type_other_div_main').hide();
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $('.case-types-div input[type="checkbox"]').on('change', function() {
                            ...
                            if($("#case_type_42").prop("checked") == true){
