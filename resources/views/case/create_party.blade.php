        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body table-sm table-responsive">
                    ...
                    <h4>{{$top_party_type}}@if($top_party_type !='Petitioner 1')(s)@endif @if($case_data->total_top_parties < $number_top_party_type)<div class="text-right"><button type="button" id="top_party_check" style="margin-bottom: 15px;" class="show-party-form btn btn-primary" data-is-client="{{ $is_client_top_bottom }}">Add {{$top_party_type}} @if($top_party_type !='Petitioner 1')(#{{$t1}})@endif</button></div>@endif</h4>
                    ...
                    <h4>{{$bottom_party_type}}@if($bottom_party_type !='Petitioner 2')(s)@endif @endif @if($case_data->total_bottom_parties < $number_bottom_party_type && (isset($top_party_data) || isset($bottom_party_data)))<div class="text-right"><button type="button" id="bottom_party_check"style="margin-bottom: 15px;" class="show-party-form btn btn-primary" data-is-client="{{ $is_client_top_bottom }}">Add {{$bottom_party_type}} @if($bottom_party_type !='Petitioner 2')(#{{$t2}})@endif</button></div>@endif</h4>
                    @if(isset($bottom_party_data))
                    <table class="table table-bordered bottom-party-table">
                     ...
                     @foreach ($bottom_party_data as $key => $party)
                      ...
                      <tr>
                        ...
                        <td><?php if(isset($party->email) && strpos($party->email, 'unknown_'.$case_id.'_') === false){ echo $party->email; } ?></td>
                    ...
                    @if($case_data->total_top_third_parties < $number_top_third_parties && $case_data->total_top_parties > 0)<div class="text-right"><button type="button" id="top_third_party_check" style="margin-bottom: 15px;" class="show-party-form btn btn-primary">Add Third-Party {{$top_party_type}} @if($top_party_type !='Petitioner 1')(#{{$t3}})@endif</button></div>@endif</h4>
                    @if(isset($top_third_party_data) && count($top_third_party_data) > 0)                    
                    ...
                    @if($case_data->total_bottom_third_parties < $number_bottom_third_parties && $case_data->total_top_parties > 0)<div class="text-right"><button type="button" id="bottom_third_party_check" style="margin-bottom: 15px;" class="show-party-form btn btn-primary">Add Third-Party {{$bottom_party_type}} @if($bottom_party_type !='Petitioner 2')(#{{$t4}})@endif</button></div>@endif</h4>
                    @if(isset($bottom_third_party_data) && count($bottom_third_party_data) > 0)
                    ...
                    @endif    
                        @csrf
                        <input type="hidden" name="prospect_id" value="<?php if(isset($prospect_client->id) && $prospect_client->id !=''){ echo $prospect_client->id; } ?>" readonly="">
                        <div class="row form-group setup-content" id="step-2">
                            ...
                            <div class="col-md-12">
                                <h4 id="title_for_top_party" style="display: none;">Register {{$top_party_type}} @if($top_party_type !='Petitioner 1')(#{{$t1}})@endif</h4>
                                <h4 id="title_for_bottom_party" style="display: none;">Register {{$bottom_party_type}} @if($bottom_party_type !='Petitioner 2')(#{{$t2}})@endif</h4>

                                <h4 id="title_for_top_third_party" style="display: none;">Register Third-Party {{$top_party_type}} @if($top_party_type !='Petitioner 1')(#{{$t3}})@endif</h4>
                                <h4 id="title_for_bottom_third_party" style="display: none;">Register Third-Party {{$bottom_party_type}} @if($bottom_party_type !='Petitioner 2')(#{{$t4}})@endif</h4>
                            ...
                            <div class="col-md-12 pauperis_div">
                                <div class="col-md-6">
                                  ...
                                  <div class="col-md-8">
                                      <input type="radio" id="pauperis-Yes" name="pauperis" class="pauperis" value="Yes">
                                      <label for="pauperis-Yes"> Yes</label>
                                      <input type="radio" id="pauperis-No" class="pauperis" name="pauperis" value="No" checked="">
                            ...
                            <div class="col-md-12 op_ally_div" style="display: none;">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <input type="radio" id="name_unknown-Yes" name="name_unknown" class="name_unknown" value="Yes">
                                        <label for="name_unknown-Yes"> Yes</label>
                                        <input type="radio" id="name_unknown-No" class="name_unknown" name="name_unknown" value="No" checked="">
                                ...
                                <div class="col-md-6 name_unknown_div" style="display: none;">
                                  <label for="gen_desc" class="col-md-4 col-form-label text-md-left">Gen Desc</label>
                                    <div class="col-md-8">
                                      <input id="gen_desc" type="text" class="form-control" name="gen_desc" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 name_unknown_div" style="display: none;">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <input type="radio" id="is_multi_desc-Yes" name="is_multi_desc" class="is_multi_desc" value="Yes">
                                        <label for="is_multi_desc-Yes"> Yes</label>
                                        <input type="radio" id="is_multi_desc-No" class="is_multi_desc" name="is_multi_desc" value="No" checked="">
                                ...
                                <div class="col-md-6 more_gen_desc">
                                  <label for="more_gen_desc" class="col-md-4 col-form-label text-md-left">More Gen Desc</label>
                                    <div class="col-md-8">
                                      <input id="more_gen_desc" type="text" class="form-control" name="more_gen_desc" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <input id="clfname" type="text" class="form-control" name="clfname" value="<?php if(isset($prospect_client->prosp_fname) && $prospect_client->prosp_fname !=''){ echo $prospect_client->prosp_fname; } ?>" required=""  autofocus="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <input id="clmname" type="text" class="form-control " name="clmname" value="<?php if(isset($prospect_client->prosp_mname) && $prospect_client->prosp_mname !=''){ echo $prospect_client->prosp_mname; } ?>" autofocus="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="cllname" class="col-md-4 col-form-label text-md-left">Last Name*</label>
                                    <div class="col-md-8">
                                        <input id="cllname" type="text" class="form-control" name="cllname" value="<?php if(isset($prospect_client->prosp_lname) && $prospect_client->prosp_lname !=''){ echo $prospect_client->prosp_lname; } ?>" required=""  autofocus="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <label for="clemail" class="col-md-4 col-form-label text-md-left">Email<span id="email_asterisk">*</span></label>
                                    <div class="col-md-8">
                                        <input id="clemail" type="email" class="form-control" name="clemail" value="<?php if(isset($prospect_client->prosp_email) && $prospect_client->prosp_email !=''){ echo $prospect_client->prosp_email; } ?>" autofocus="" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="clphone" class="col-md-4 col-form-label text-md-left">Telephone</label>
                                    <div class="col-md-8">
                                        <input id="clphone" type="text" class="form-control has-pattern-one" name="clphone" value="<?php if(isset($prospect_client->prosp_phone) && $prospect_client->prosp_phone !=''){ echo $prospect_client->prosp_phone; } ?>" autofocus="" placeholder="XXX-XXX-XXXX">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <select id="clsuffix" name="clsuffix" class="form-control" autofocus="">
                                            ...
                                            <option value="Sr." <?php if(isset($prospect_client->prosp_sufname) && $prospect_client->prosp_sufname=='Sr.'){ echo 'selected'; } ?>>Sr.</option>
                                            <option value="Jr." <?php if(isset($prospect_client->prosp_sufname) && $prospect_client->prosp_sufname=='Jr.'){ echo 'selected'; } ?>>Jr.</option>
                                            <option value="I" <?php if(isset($prospect_client->prosp_sufname) && $prospect_client->prosp_sufname=='I'){ echo 'selected'; } ?>>I</option>
                                            <option value="II" <?php if(isset($prospect_client->prosp_sufname) && $prospect_client->prosp_sufname=='II'){ echo 'selected'; } ?>>II</option>
                                            <option value="III" <?php if(isset($prospect_client->prosp_sufname) && $prospect_client->prosp_sufname=='III'){ echo 'selected'; } ?>>III</option>
                                            <option value="IV" <?php if(isset($prospect_client->prosp_sufname) && $prospect_client->prosp_sufname=='IV'){ echo 'selected'; } ?>>IV</option>
                                        </select>    
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <label for="short_name" class="col-md-4 col-form-label text-md-left" id="label_when_top_party">{{$top_party_type}} @if($top_party_type !='Petitioner 1')(#{{$t1}})@endif Short Name for Pleadings/Motions</label>
                                    <label for="short_name" class="col-md-4 col-form-label text-md-left" id="label_when_bottom_party" style="display: none;">{{$bottom_party_type}} @if($bottom_party_type !='Petitioner 2')(#{{$t2}})@endif Short Name for Pleadings/Motions</label>

                                    <label for="short_name" class="col-md-4 col-form-label text-md-left" id="label_when_top_third_party" style="display: none;">Third-Party {{$top_party_type}} @if($top_party_type !='Petitioner 1')(#{{$t3}})@endif Short Name for Pleadings/Motions</label>
                                    <label for="short_name" class="col-md-4 col-form-label text-md-left" id="label_when_bottom_third_party" style="display: none;">Third-Party {{$bottom_party_type}} @if($bottom_party_type !='Petitioner 2')(#{{$t4}})@endif Short Name for Pleadings/Motions</label>
                                    <div class="col-md-8">
                                ...
                                <div class="col-md-6 cldob-main-div">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control hasDatepicker" id="cldob" name="cldob" placeholder="MM/DD/YYYY" value="" autofocus="" autocomplete="off">
                                    </div>
                                </div>    
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-4 single-line-radio-div">
                                    ...
                                    <div class="col-md-6">
                                        <input type="radio" id="clgen-m" class="gender-input" name="clgender" value="M" required=""  >
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6 client_relation_other_div" style="margin-top: 20px; display: none;">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="relation_other" name="other_relation" value="" autofocus>
                                        </select>
                                    </div>
                                </div>
                            <div class="col-md-12">
                                <div class="col-md-6 op_ally_div" style="display: none;">
                                    ...
                                    <div class="col-md-8">
                                        <input type="radio" id="address_unknown-Yes" name="address_unknown" class="address_unknown" value="Yes">
                                        <label for="address_unknown-Yes"> Yes</label>
                                        <input type="radio" id="address_unknown-No" class="address_unknown" name="address_unknown" value="No" checked="">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-danger no-state-county-cl" style="display: none;">No City, State, County found for this zipcode.</p>
                                        <input type="text" class="form-control" id="clzip" name="clzip" value="<?php if(isset($prospect_client->prosp_zip) && $prospect_client->prosp_zip !=''){ echo $prospect_client->prosp_zip; } ?>" autofocus="" required="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                      <input type="hidden" name="selected-state-cl" value="<?php if(isset($prospect_client->prosp_state_id)){ echo $prospect_client->prosp_state_id; } ?>" class="selected-state-cl">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                      <input type="hidden" name="selected-city-cl" value="<?php if(isset($prospect_client->prosp_city)){ echo $prospect_client->prosp_city; } ?>" class="selected-city-cl">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="clstreetad" name="clstreetad" value="<?php if(isset($prospect_client->prosp_street_ad) && $prospect_client->prosp_street_ad !=''){ echo $prospect_client->prosp_street_ad; } ?>" autofocus="" required="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <input id="unit" type="text" class="form-control " name="unit" value="<?php if(isset($prospect_client->prosp_unit) && $prospect_client->prosp_unit !=''){ echo $prospect_client->prosp_unit; } ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="pobox" class="col-md-4 col-form-label text-md-left">PO Box</label>
                                    <div class="col-md-8">
                                        <input id="pobox" type="text" class="form-control" name="pobox" value="<?php if(isset($prospect_client->prosp_pobox) && $prospect_client->prosp_pobox !=''){ echo $prospect_client->prosp_pobox; } ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 text-md-center">
                                <button class="btn btn-primary nextBtn" id="party_submit_btn" type="submit">Submit</button>
                            </div>
                        </div>
