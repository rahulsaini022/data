        ...
        <div class="col-md-12">
            <div class="card">
                <?php 
                    ...
                    ?>
                <div class="card-header">Attorney Registration For {{$user_party_group}} @if($user_party_group !='Petitioner 1')(#{{$party_number}})@endif
                ...
                <div class="card-body">
                    ...
                    ?>
                    <h4>Attorneys For {{$user_party_group}} @if($user_party_group !='Petitioner 1')(#{{$party_number}})@endif 
                        @if($t<3)
                    ...
                    <table class="table table-bordered table-responsive">
                     ...
                     @foreach ($party_attorney as $key => $partyattorney)
                      ...
                      <tr>
                        ...
                        <td><?php if(isset($partyattorney->email) && strpos($partyattorney->email, 'unknown_'.$case_id.'_') === false){ echo $partyattorney->email; } ?></td>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <h4 style="margin-left: -30px;">For {{$user_party_group}} @if($user_party_group !='Petitioner 1')(#{{$party_number}})@endif</h4>
                        </div>
                    @endif
                        <div class="col-md-6">
                    ...
                    @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-1">
                                <input id="trial_attorney" type="checkbox" class="form-control @error('trial_attorney') is-invalid @enderror" name="trial_attorney" value="Yes" style="width: 15px;" <?php if ($t=='1'){ echo " checked"; } ?>>
                            </div>
                            @endif
                            @if(isset($total_customer_attorney) && $total_customer_attorney=='0' &&  $user_party_group !='Defendant')
                            <label for="customer_attorney" class="col-md-2 col-form-label text-md-left">{{ $customer_attorney_info->document_sign_name }}</label>

                            <div class="col-md-1">
                                <input id="" type="checkbox" class="form-control customer_attorney" name="customer_attorney" value="Yes" style="width: 15px;" <?php if ($t=='1'){ echo " data-onload='isCustomerAttorney(this)' "; } else { echo "onchange='isCustomerAttorney(this)'"; } ?>  data-reg = "{{ $customer_attorney_info->attorney_reg_1_num  }}" data-id = "{{ Auth::user()->id }}" <?php if ($t=='1'){ echo " checked"; } ?>>
                            </div>
                            @endif
                             @if(isset($party_attorney) && !empty($party_attorney) && $user_party_group == 'Defendant')
                              ...
                              ?>
                              <label for="customer_attorney" class="col-md-2 col-form-label text-md-left">{{ $attorney->name }}</label>
                               <div class="col-md-1">
                                <input id="" type="checkbox" class="form-control customer_attorney" name="customer_attorney" value="Yes" data-reg = "{{ $customer_attorney_infos->attorney_reg_1_num }}" data-id = "{{ $customer_attorney_infos->user_id }}" style="width: 15px;" <?php //if ($t=='1'){ echo "onclick='return false' data-onload='isCustomerAttorney(this)' checked"; } else { echo "onchange='isCustomerAttorney(this)'"; } ?> >
                            </div>
                            @endforeach
                            @endif
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="currentstatus" type="text" class="form-control @error('currentstatus') is-invalid @enderror" name="currentstatus" value="{{ old('currentstatus') }}"  autocomplete="currentstatus">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="admissiondate" type="text" class="form-control @error('admissiondate') is-invalid @enderror hasDatepicker" name="admissiondate" value="{{ old('admissiondate') }}" autocomplete="admissiondate" >
        ...
        <form method="POST" action="">
            ...
            <DIV class="row">
                <div class="col-sm-12 mb-3">
                    ...
                    <input type="number" min="0" class="form-control" name="" id="search_reg" placeholder="Registration Number">
                </div>
