...
<div class="row">
  ...
  <div class="col-sm-12">
    <div style="float: left;">
      <input type="button" name="reset" value="Reset to blank" class="btn btn-info" onclick="resetFormToBlank();">
    </div>
    <div style="text-align: right;">
        <form method="POST" action="{{route('cases.prefill_from_db_computations_sheet')}}" autocomplete="off">
          ...
          <input type="submit" class="btn btn-info" value="Fill from database">
        </form>
    </div>
  </div>
  <?php } ?>
     ...
     <form id="entryform" method="post" action="{{ route('computations.split') }}" onsubmit="return validateSplitForm();" >
          @csrf
              ...
              <input data-number-to-fixed="2" data-number-stepfactor="100" step="0.01" class="text-center readonly-feild currency" type="number" id="obligor_36" name="obligor_36"  placeholder="Calculate" value="<?php echo ((isset($postData['obligor_36'])) && ($postData['obligor_36'] != '')) ? $postData['obligor_36']:0; ?>" readonly>
                ...
                <tr class="print-none">
                  ...
                  <td colspan="4" style="text-align: right;">
                    ...
                    <br/><br/>
                    <input type="submit" name="submit_email" value="Print" class="btn btn-success" style="display: none;">
