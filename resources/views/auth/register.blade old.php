                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('attorneys.store')}}" id="attorney_reg_form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="pro_hac_vice" type="checkbox" class="form-control  margin @error('pro_hac_vice') is-invalid @enderror" name="pro_hac_vice" value="yes" style="width: 15px;">
                                
                            </div>

                            <label class="col-md-2 col-form-label text-md-left"></label>
                            <div class="col-md-4" id="noattorney" style="display: none;"><span class="text-danger">No attorney data found for this reg number.Please <a href="{{ url('email-us') }}" target="_blank">contact us</a>, if you are not able to register with your Registration Number.</span></div>
                        ...
                        <div class="form-group row">
                            ...
                            <label for="attorney_reg_1_num" class="col-md-2 col-form-label text-md-left attorney_reg_1_num_label">{{ __('Attorney Reg #1*') }}
                            <i class="fa fa-search lookupicone col-md-1 text-md-left" aria-hidden="true" data-toggle="modal" data-target="#myNewDynamicModal"></i></label>
