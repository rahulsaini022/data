                        ...
                        <div class="col-sm-12 filter-section">
                            <div class="row">
                                ...
                                <div class="col-sm-3 offset-sm-1">
                                    <form action="{{ route('attorney.search') }}" id="searchForm" method="post">
                                        @csrf
                                        <div class="input-group">

                                            <input class="form-control py-2" name="search" type="search"
                                                value="@if (isset($data)) {{ $data }} @endif"
                                                required placeholder="search" id="example-search-input">
                                                        ...
                                                        @foreach ($service->image as $key => $image)
                                                            @if ($key == 0)
                                                                <a href="{{ route('ads_details', $service->id) }}"> <img
                                                                        src="{{ asset('uploads/AD_images/' . $image->image) }}"
