                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('attorneys.update',['id'=>$attorney->id])}}" id="attorney_edit_form" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="prefill_from_permanent_data" class="col-md-2 col-form-label text-md-left">{{ __('Prefill from permanent data') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="fname" type="text"  onfocus="this.value = this.value;"  class="form-control @error('fname') is-invalid @enderror" name="fname" value="<?php if(isset($fullname[0])){ echo $fullname[0]; } ?>" required autocomplete="fname" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="birthdate" type="text" class="form-control @error('birthdate') is-invalid @enderror hasDatepicker" name="birthdate" value="<?php if(isset($attorney_data->birthdate)){ echo date("m/d/Y", strtotime($attorney_data->birthdate)); } ?>" autocomplete="birthdate" disabled="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="admissiondate" type="text" class="form-control @error('admissiondate') is-invalid @enderror hasDatepicker" name="admissiondate" value="<?php if(isset($attorney_data->admissiondate)){ echo date("m/d/Y", strtotime($attorney_data->admissiondate)); } ?>" autocomplete="admissiondate" disabled="">
                            ...
                            <div class="col-md-4">
                                <input id="howadmitted" type="text" class="form-control @error('howadmitted') is-invalid @enderror" name="howadmitted" value="<?php if(isset($attorney_data)){ echo $attorney_data->howadmitted; } ?>" autocomplete="howadmitted" readonly="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="firm_telephone" type="text" class="form-control @error('firm_telephone') is-invalid @enderror" name="firm_telephone" value="<?php if(isset($attorney_data)){ echo $attorney_data->firm_telephone; } ?>" autocomplete="firm_telephone" autofocus placeholder="(XXX)XXX-XXXX">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="attorney_reg_1_num" class="col-md-2 col-form-label text-md-left">{{ __('Attorney Reg #1*') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <?php if(isset($attorney_data->pro_vice_hac_num) && $attorney_data->pro_vice_hac_num != ''){ ?>
                             <label for="pro_vice_hac_num" class="col-md-2 col-form-label text-md-left pro_vice_hac_label">{{ __('Pro Hac Vice #*') }}</label>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data==null || data=='null'){
                    ...
                    if(sel_county){
                        $('#legal_aid_county option[value='+sel_county+']').attr('selected','selected');
                    }
                }
            }
        });
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data==null || data=='null'){
                    ...
                    if(sel_reg_1_state){
                        $('#attorney_reg_1_state_id option[value='+sel_reg_1_state+']').attr('selected','selected');
                    }
