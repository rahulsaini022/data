            ...
            <div class="card">
                ...
                <div class="card-body">
                   @if (isset($stripe_error))
                    ...
                    @if ($attorney->subscribed('main') && !empty($subscription_data)) 
                    <?php
                        ...
                        <table class="table table-bordered main-state-subscription-table table-responsive">
                            ...
                            <tbody>
                                 <tr>
                                    ...
                                    <td > 
                                       <p class="text-capitalize"> @if ($subscription_data->cancel_at_period_end)
                                              {{'Cancelled'}}
                                              @else
                    ...
                    <!--     <p> Purchase Second State Seat License Subscription Plan to Add Second State and State Attorney Number For $150. It will be an <strong>Annual Recurring Subscription.</strong> You can cancel it anytime. </p> -->
                        <div class="cc-payment-outer payment-cc-main state-seat-license-payment-div">
                            ...
                            <div class="cc-name-outer" style="float: none;">
                                ...
                                <div class="cc-package-box">
                                    <label for="payment_attorney_reg_2_num" class="col-form-label text-md-left">Attorney Reg #2*</label>
                                    <input id="payment_attorney_reg_2_num" type="text" class="form-control" name="payment_attorney_reg_2_num" value="{{ $attorney_data->attorney_reg_1_num}}" required="">
                                </div>
                    ...
                    ?>
                    <h5 style="display:none;"> Second State License Subscription details.</h5>
                        <table class="table table-bordered second-state-subscription-table table-responsive" style="display:none;">
                            <thead>
                                <tr>
                                    <th><div style="width: 130px;">State Name</div></th>
                                    <th><div style="width: 150px;">State Reg Num</div></th>
                    ...
                    <div class="row mb-5" style="display:none;">
                        ...
                        <div class="cc-payment-outer payment-cc-main state-seat-license-payment-div">
                            ...
                            <div class="cc-name-outer" style="float: none;">
                                <div class="cc-package-box">
                                    <label for="payment_attorney_reg_2_state_id" class="col-form-label text-md-left">Attorney Reg #2 State*</label>
                                    <select id="payment_attorney_reg_2_state_id" name="payment_attorney_reg_2_state_id" class="form-control states_select_input" required="">
                    ...
                    <!-- for third state seat license purchase -->
                        @if ($attorney->subscribed('third_state_seat_license_plan')) 
                            ...
                            ?>
                            <h5 style="display:none"> Third State License Subscription details.</h5>
                            <table class="table table-bordered third-state-subscription-table table-responsive" style="display:none">
                                <thead>
                                    <tr>
                                        <th><div style="width: 130px;">State Name</div></th>
                                        <th><div style="width: 150px;">State Reg Num</div></th>
