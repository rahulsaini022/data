...
<div class="container">
    <div class="row justify-content-center dr_monthlyhealthcareexpenses_main">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><strong>{{ __('Monthly Health Care Expenses Info') }}</strong>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form role="form" id="dr_monthlyhealthcareexpenses" method="POST" action="{{route('drmonthlyhealthcareexpenses.store')}}" autocomplete="off">
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Client_Monthly_Physicians_NOT_COVERED" type="number" class="form-control" name="Client_Monthly_Physicians_NOT_COVERED" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Client_Monthly_Dentists_NOT_COVERED" type="number" class="form-control" name="Client_Monthly_Dentists_NOT_COVERED" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Client_Monthly_Optometrists_Opticians_NOT_COVERED" type="number" class="form-control" name="Client_Monthly_Optometrists_Opticians_NOT_COVERED" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Client_Monthly_Prescriptions_NOT_COVERED" type="number" class="form-control" name="Client_Monthly_Prescriptions_NOT_COVERED" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Client_Monthly_Health_Care_Other_NOT_COVERED_Name1" type="text" class="form-control" name="Client_Monthly_Health_Care_Other_NOT_COVERED_Name1" value=""> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Client_Monthly_Health_Care_Other_NOT_COVERED_Amount1" type="number" class="form-control" name="Client_Monthly_Health_Care_Other_NOT_COVERED_Amount1" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Client_Monthly_Health_Care_Other_NOT_COVERED_Name2" type="text" class="form-control" name="Client_Monthly_Health_Care_Other_NOT_COVERED_Name2" value=""> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Client_Monthly_Health_Care_Other_NOT_COVERED_Amount2" type="number" class="form-control" name="Client_Monthly_Health_Care_Other_NOT_COVERED_Amount2" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                            </div>
                        ...
                        <div class="form-row mt-4">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Op_Monthly_Physicians_NOT_COVERED" type="number" class="form-control" name="Op_Monthly_Physicians_NOT_COVERED" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Op_Monthly_Dentists_NOT_COVERED" type="number" class="form-control" name="Op_Monthly_Dentists_NOT_COVERED" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Op_Monthly_Optometrists_Opticians_NOT_COVERED" type="number" class="form-control" name="Op_Monthly_Optometrists_Opticians_NOT_COVERED" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Op_Monthly_Prescriptions_NOT_COVERED" type="number" class="form-control" name="Op_Monthly_Prescriptions_NOT_COVERED" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Op_Monthly_Health_Care_Other_NOT_COVERED_Name1" type="text" class="form-control" name="Op_Monthly_Health_Care_Other_NOT_COVERED_Name1" value=""> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Op_Monthly_Health_Care_Other_NOT_COVERED_Amount1" type="number" class="form-control" name="Op_Monthly_Health_Care_Other_NOT_COVERED_Amount1" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Op_Monthly_Health_Care_Other_NOT_COVERED_Name2" type="text" class="form-control" name="Op_Monthly_Health_Care_Other_NOT_COVERED_Name2" value=""> 
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input id="Op_Monthly_Health_Care_Other_NOT_COVERED_Amount2" type="number" class="form-control" name="Op_Monthly_Health_Care_Other_NOT_COVERED_Amount2" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                            </div>
