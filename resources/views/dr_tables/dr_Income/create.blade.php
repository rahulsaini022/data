...
<div class="container">
    <div class="row justify-content-center dr_Income_main dr_Tables_main">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><strong>{{ __('Income Info') }}</strong>
                ...
                <div class="card-body">
                    ...
                    <form role="form" id="dr_Income" method="POST" action="{{route('drincome.store')}}" autocomplete="off">
                        @csrf
                            ...
                            <div class="col-sm-12 mt-3">
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="w-100 dataInput">
                                         <label><input type="radio" id="Client_Employed_Yes" name="Client_Employed" value="Yes" onchange="isEmployed(this, 'Client');"> Yes</label>
                                         <label><input type="radio" id="Client_Employed_No" name="Client_Employed" value="No" onchange="isEmployed(this, 'Client');"> No</label>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6 Client_is_Employed_Div" style="display: none;">
                                    <label for="Client_Inc_Employer">Employer</label>
                                    <input id="Client_Inc_Employer" type="text" class="form-control Client_Income_inputs" name="Client_Inc_Employer" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Client_is_Employed_Div" style="display: none;">
                                    <label for="Client_Inc_Employer_Payroll_Street_Address">Employer Street Address</label>
                                    <input id="Client_Inc_Employer_Payroll_Street_Address" type="text" class="form-control Client_Income_inputs" name="Client_Inc_Employer_Payroll_Street_Address" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Client_is_Employed_Div" style="display: none;">
                                    <label for="Client_Inc_Employer_Payroll_City_State_Zip">Employer City, State Zip</label>
                                    <input id="Client_Inc_Employer_Payroll_City_State_Zip" type="text" class="form-control Client_Income_inputs" name="Client_Inc_Employer_Payroll_City_State_Zip" value=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label>Wages Actual or Estimated?</label>
                                    <div class="w-100 dataInput">
                                         <label><input type="radio" id="Client_Wages_Actual_Actual" name="Client_Wages_Actual" value="Actual"> Actual</label>
                                         <label><input type="radio" id="Client_Wages_Actual_Estimated" name="Client_Wages_Actual" value="Estimated"> Estimated</label>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_RegWage_YTD_MinWage">Are wages regular/salary, irregular/seasonal, or minimum wage?</label>
                                    <select id="Client_RegWage_YTD_MinWage" name="Client_RegWage_YTD_MinWage" class="form-control Client_Income_inputs" onchange="onMinWageChange(this, 'Client');">
                                        <option value="1">Regular/salary</option>
                                        <option value="2">Irregular/seasonal</option>
                                        <option value="3">Minimum Wage</option>
                                    </select>   
                                </div>
                                <div class="form-group col-sm-6 Client_RegWage_YTD_MinWage_Div Client_RegWage_YTD_MinWage_1_Div">
                                    ...
                                    <input id="Client_Wages_per_Period" type="number" class="form-control Client_Income_inputs" name="Client_Wages_per_Period" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="calculateBaseYearlyWagesByPerYear(this, 'Client');"> 
                                </div>
                                <div class="form-group col-sm-6 Client_RegWage_YTD_MinWage_Div Client_RegWage_YTD_MinWage_1_Div">
                                ...
                                <div class="form-group col-sm-6 Client_RegWage_YTD_MinWage_Div Client_RegWage_YTD_MinWage_2_Div" style="display: none;">
                                    ...
                                    <input id="Client_Pay_YTD" type="number" class="form-control Client_Income_inputs" name="Client_Pay_YTD" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="calculateBaseYearlyWagesByYTDPayDate(this, 'Client');"> 
                                </div>
                                <div class="form-group col-sm-6 Client_RegWage_YTD_MinWage_Div Client_RegWage_YTD_MinWage_2_Div" style="display: none;">
                                    <label for="Client_YTD_Date">YTD Pay Date</label>
                                    <input id="Client_YTD_Date" type="text" class="form-control hasDatepicker Client_Income_inputs" name="Client_YTD_Date" value="" onchange="calculateBaseYearlyWagesByYTDPayDate(this, 'Client');"> 
                                </div>
                                <div class="form-group col-sm-6 Client_RegWage_YTD_MinWage_3_Div Client_RegWage_YTD_MinWage_Base_Yearly_Wages_Div">
                                    ...
                                    <input id="Client_Base_Yearly_Wages" type="number" class="form-control Client_Income_inputs" name="Client_Base_Yearly_Wages" value="0.00" min="0.00" step="0.01" max="999999.99" readonly=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Last_Year_Base_Wages">Last Year Base Wages? (Yearly)</label>
                                    <input id="Client_Last_Year_Base_Wages" type="number" class="form-control Client_Income_inputs" name="Client_Last_Year_Base_Wages" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Year_Before_Last_Year_Base_Wages">Two Years Ago Base Wages (Yearly)?</label>
                                    <input id="Client_Year_Before_Last_Year_Base_Wages" type="number" class="form-control Client_Income_inputs" name="Client_Year_Before_Last_Year_Base_Wages" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Two_Years_Before_Last_Year_Base_Wages">Three Years Ago Base Wages (Yearly)?</label>
                                    <input id="Client_Two_Years_Before_Last_Year_Base_Wages" type="number" class="form-control Client_Income_inputs" name="Client_Two_Years_Before_Last_Year_Base_Wages" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Most_Recent_Yearly_OT_Comms_Bonuses">Last Year Overtime, Commissions, Bonuses, Etc. (Yearly)?</label>
                                    <input id="Client_Most_Recent_Yearly_OT_Comms_Bonuses" type="number" class="form-control Client_Income_inputs" name="Client_Most_Recent_Yearly_OT_Comms_Bonuses" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getMinAvgCommBonuses(this, 'Client');"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Second_Most_Recent_Yearly_OT_Comms_Bonuses">Two Years Ago Overtime, Commissions, Bonuses, Etc. (Yearly)?</label>
                                    <input id="Client_Second_Most_Recent_Yearly_OT_Comms_Bonuses" type="number" class="form-control Client_Income_inputs" name="Client_Second_Most_Recent_Yearly_OT_Comms_Bonuses" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getMinAvgCommBonuses(this, 'Client');"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Third_Most_Recent_Yearly_OT_Comms_Bonuses">Three Years Ago Overtime, Commissions, Bonuses, Etc. (Yearly)?</label>
                                    <input id="Client_Third_Most_Recent_Yearly_OT_Comms_Bonuses" type="number" class="form-control Client_Income_inputs" name="Client_Third_Most_Recent_Yearly_OT_Comms_Bonuses" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getMinAvgCommBonuses(this, 'Client');"> 
                                </div>
                                <div class="form-group col-sm-6" style="display: none;">
                                    <label for="Client_Min_Ave_OT_Comms_Bonuses">N/A = MIN(L24,(L24+L25+L26)/3)</label>
                                    <input id="Client_Min_Ave_OT_Comms_Bonuses" type="number" class="form-control Client_Income_inputs" name="Client_Min_Ave_OT_Comms_Bonuses" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Yearly_Unemployment_Compensation">Current Yearly Unemployment Compensation?</label>
                                    <input id="Client_Yearly_Unemployment_Compensation" type="number" class="form-control Client_Income_inputs" name="Client_Yearly_Unemployment_Compensation" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Yearly_Workers_Compensation">Current Yearly Workers’ Compensation?</label>
                                    <input id="Client_Yearly_Workers_Compensation" type="number" class="form-control Client_Income_inputs" name="Client_Yearly_Workers_Compensation" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Yearly_Social_Security_Disability">Current Yearly Social Security Disability?</label>
                                    <input id="Client_Yearly_Social_Security_Disability" type="number" class="form-control Client_Income_inputs" name="Client_Yearly_Social_Security_Disability" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Yearly_Other_Disability_Source">Source of Yearly Disability Income Other than Social Security?</label>
                                    <input id="Client_Yearly_Other_Disability_Source" type="text" class="form-control Client_Income_inputs" name="Client_Yearly_Other_Disability_Source" value=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Yearly_Other_Disability_Income">Current Yearly Income for Disability Other than Social Security?</label>
                                    <input id="Client_Yearly_Other_Disability_Income" type="number" class="form-control Client_Income_inputs" name="Client_Yearly_Other_Disability_Income" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Yearly_Social_Security_Retirement">Current Yearly Social Security Retirement Income?</label>
                                    <input id="Client_Yearly_Social_Security_Retirement" type="number" class="form-control Client_Income_inputs" name="Client_Yearly_Social_Security_Retirement" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Yearly_Gross_Self_Employment_Income">Current Yearly Gross Self-Employment Income?</label>
                                    <input id="Client_Yearly_Gross_Self_Employment_Income" type="number" class="form-control Client_Income_inputs" name="Client_Yearly_Gross_Self_Employment_Income" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Yearly_Self_Employment_Expenses">Current Yearly Self-Employment Expenses?</label>
                                    <input id="Client_Yearly_Self_Employment_Expenses" type="number" class="form-control Client_Income_inputs" name="Client_Yearly_Self_Employment_Expenses" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input id="Client_Yearly_Interest_Dividends" type="number" class="form-control Client_Income_inputs" name="Client_Yearly_Interest_Dividends" value="<?php if(isset($Client_Yearly_Interest_Dividends)){ echo $Client_Yearly_Interest_Dividends; } else { echo "0.00"; } ?>" step="0.01" max="999999.99" readonly=""> 
                                </div>
                                <div class="form-group col-sm-6" style="display: none;">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input id="Client_Monthly_Mandatory_Work_Deductions_NOT_TAXES_Type" type="text" class="form-control Client_Income_inputs" name="Client_Monthly_Mandatory_Work_Deductions_NOT_TAXES_Type" value=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    ...
                                    <input id="Client_Monthly_Mandatory_Work_Deductions_NOT_TAXES_Amt" type="number" class="form-control Client_Income_inputs" name="Client_Monthly_Mandatory_Work_Deductions_NOT_TAXES_Amt" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getYearlyDeduction(this, 'Client');"> 
                                </div>
                                <div class="form-group col-sm-6" style="display: none;">
                                    ...
                                    <input id="Client_Yearly_Mandatory_Work_Deductions_NOT_TAXES_Amt" type="number" class="form-control Client_Income_inputs" name="Client_Yearly_Mandatory_Work_Deductions_NOT_TAXES_Amt" value="0.00" min="0.00" step="0.01" max="999999.99" readonly=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Position">Work Position</label>
                                    <input id="Client_Position" type="text" class="form-control Client_Income_inputs" name="Client_Position" value=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Weekly_Hours">Work Hours per Week</label>
                                    <input id="Client_Weekly_Hours" type="number" class="form-control Client_Income_inputs" name="Client_Weekly_Hours" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Work_Phone">Work Phone</label>
                                    <input id="Client_Work_Phone" type="text" class="form-control Client_Income_inputs phone_input" name="Client_Work_Phone" value="" placeholder="(XXX) XXX-XXXX"> 
                                </div>
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input id="Client_Monthly_SSI" type="number" class="form-control Client_Income_inputs" name="Client_Monthly_SSI" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getYearlySSI(this, 'Client');">
                                </div>
                                <div class="form-group col-sm-6" style="display: none;">
                                    <label for="Client_Yearly_SSI">N/A, Calculated = 12*Client_Monthly_SSI</label>
                                    <input id="Client_Yearly_SSI" type="number" class="form-control Client_Income_inputs" name="Client_Yearly_SSI" value="0.00" min="0.00" step="0.01" max="999999.99" readonly=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Client_Monthly_Public_Assistance_Amt">Amount of Monthly Public Assistance?</label>
                                    <input id="Client_Monthly_Public_Assistance_Amt" type="number" class="form-control Client_Income_inputs" name="Client_Monthly_Public_Assistance_Amt" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getYearlyPublicAssistanceAmt(this, 'Client');"> 
                                </div>
                                <div class="form-group col-sm-6" style="display: none;">
                                    <label for="Client_Yearly_Public_Assistance_Amt">N/A, Calculated = 12*Client_Inc_Monthly_Public_Assistance_Amt</label>
                                    <input id="Client_Yearly_Public_Assistance_Amt" type="number" class="form-control Client_Income_inputs" name="Client_Yearly_Public_Assistance_Amt" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="w-100 dataInput">
                                         <label><input type="checkbox" id="Client_Other_Source_Income" name="Client_Other_Source_Income" value="1" onchange="hasAnotherSourceOfIncome(this, 'Client');"> Yes</label>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Client_Other_Source_Name1" type="text" class="form-control Client_Income_inputs phone_input" name="Client_Other_Source_Name1" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Client_Other_Source_Zip1" type="text" class="form-control Client_Income_inputs 1_Client_Other_Income_inputs" name="Client_Other_Source_Zip1" value="" onkeyup="getCityStateForZip(this, '1_Client');"> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Street_Address1">Other Source of Income #1 Street Address?</label>
                                    <input id="Client_Other_Source_Street_Address1" type="text" class="form-control Client_Income_inputs 1_Client_Other_Income_inputs" name="Client_Other_Source_Street_Address1" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                ...
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Client_Other_Source_Acct_Num_or_Description1" type="text" class="form-control Client_Income_inputs 1_Client_Other_Income_inputs" name="Client_Other_Source_Acct_Num_or_Description1" value="">
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Yearly_Income1">Yearly Amount of Other Source of Income #1</label>
                                    <input id="Client_Other_Source_Yearly_Income1" type="number" class="form-control Client_Income_inputs" name="Client_Other_Source_Yearly_Income1" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getOtherYearlyIncomeTotal(this, 'Client');">
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Name2">Name of Other Source of Income #2</label>
                                    <input id="Client_Other_Source_Name2" type="text" class="form-control Client_Income_inputs phone_input" name="Client_Other_Source_Name2" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Client_Other_Source_Zip2" type="text" class="form-control Client_Income_inputs 2_Client_Other_Income_inputs" name="Client_Other_Source_Zip2" value="" onkeyup="getCityStateForZip(this, '2_Client');"> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Street_Address2">Other Source of Income #2 Street Address?</label>
                                    <input id="Client_Other_Source_Street_Address2" type="text" class="form-control Client_Income_inputs 2_Client_Other_Income_inputs" name="Client_Other_Source_Street_Address2" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                ...
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Client_Other_Source_Acct_Num_or_Description2" type="text" class="form-control Client_Income_inputs 2_Client_Other_Income_inputs" name="Client_Other_Source_Acct_Num_or_Description2" value="">
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Yearly_Income2">Yearly Amount of Other Source of Income #2</label>
                                    <input id="Client_Other_Source_Yearly_Income2" type="number" class="form-control Client_Income_inputs" name="Client_Other_Source_Yearly_Income2" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getOtherYearlyIncomeTotal(this, 'Client');"> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Name3">Name of Other Source of Income #3</label>
                                    <input id="Client_Other_Source_Name3" type="text" class="form-control Client_Income_inputs phone_input" name="Client_Other_Source_Name3" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Client_Other_Source_Zip3" type="text" class="form-control Client_Income_inputs 3_Client_Other_Income_inputs" name="Client_Other_Source_Zip3" value="" onkeyup="getCityStateForZip(this, '3_Client');"> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Street_Address3">Other Source of Income #3 Street Address?</label>
                                    <input id="Client_Other_Source_Street_Address3" type="text" class="form-control Client_Income_inputs 3_Client_Other_Income_inputs" name="Client_Other_Source_Street_Address3" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                ...
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Client_Other_Source_Acct_Num_or_Description3" type="text" class="form-control Client_Income_inputs 3_Client_Other_Income_inputs" name="Client_Other_Source_Acct_Num_or_Description3" value="">
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Yearly_Income3">Yearly Amount of Other Source of Income #3</label>
                                    <input id="Client_Other_Source_Yearly_Income3" type="number" class="form-control Client_Income_inputs" name="Client_Other_Source_Yearly_Income3" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getOtherYearlyIncomeTotal(this, 'Client');"> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Name4">Name of Other Source of Income #4</label>
                                    <input id="Client_Other_Source_Name4" type="text" class="form-control Client_Income_inputs phone_input" name="Client_Other_Source_Name4" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Client_Other_Source_Zip4" type="text" class="form-control Client_Income_inputs 4_Client_Other_Income_inputs" name="Client_Other_Source_Zip4" value="" onkeyup="getCityStateForZip(this, '4_Client');"> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Street_Address4">Other Source of Income #4 Street Address?</label>
                                    <input id="Client_Other_Source_Street_Address4" type="text" class="form-control Client_Income_inputs 4_Client_Other_Income_inputs" name="Client_Other_Source_Street_Address4" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                ...
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Client_Other_Source_Acct_Num_or_Description4" type="text" class="form-control Client_Income_inputs 4_Client_Other_Income_inputs" name="Client_Other_Source_Acct_Num_or_Description4" value="">
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Yearly_Income4">Yearly Amount of Other Source of Income #4</label>
                                    <input id="Client_Other_Source_Yearly_Income4" type="number" class="form-control Client_Income_inputs" name="Client_Other_Source_Yearly_Income4" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getOtherYearlyIncomeTotal(this, 'Client');"> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Name5">Name of Other Source of Income #5</label>
                                    <input id="Client_Other_Source_Name5" type="text" class="form-control Client_Income_inputs phone_input" name="Client_Other_Source_Name5" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Client_Other_Source_Zip5" type="text" class="form-control Client_Income_inputs 5_Client_Other_Income_inputs" name="Client_Other_Source_Zip5" value="" onkeyup="getCityStateForZip(this, '5_Client');"> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Street_Address5">Other Source of Income #5 Street Address?</label>
                                    <input id="Client_Other_Source_Street_Address5" type="text" class="form-control Client_Income_inputs 5_Client_Other_Income_inputs" name="Client_Other_Source_Street_Address5" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                ...
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Client_Other_Source_Acct_Num_or_Description5" type="text" class="form-control Client_Income_inputs 5_Client_Other_Income_inputs" name="Client_Other_Source_Acct_Num_or_Description5" value="">
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Source_Yearly_Income5">Yearly Amount of Other Source of Income #5</label>
                                    <input id="Client_Other_Source_Yearly_Income5" type="number" class="form-control Client_Income_inputs" name="Client_Other_Source_Yearly_Income5" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getOtherYearlyIncomeTotal(this, 'Client');"> 
                                </div>
                                <div class="form-group col-sm-6 Client_Other_Source_Income_Div" style="display: none;">
                                    <label for="Client_Other_Yearly_Income_Total">Total Yearly Amount of Other Sources of Income</label>
                                    <input id="Client_Other_Yearly_Income_Total" type="number" class="form-control Client_Income_inputs" name="Client_Other_Yearly_Income_Total" value="0.00" min="0.00" step="0.01" max="999999.99" readonly=""> 
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row mt-2 Op_Income_section">
                            ...
                            <div class="col-sm-12 mt-3">
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="w-100 dataInput">
                                         <label><input type="radio" id="Op_Employed_Yes" name="Op_Employed" value="Yes" onchange="isEmployed(this, 'Op');"> Yes</label>
                                         <label><input type="radio" id="Op_Employed_No" name="Op_Employed" value="No" onchange="isEmployed(this, 'Op');"> No</label>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6 Op_is_Employed_Div" style="display: none;">
                                    <label for="Op_Inc_Employer">Employer</label>
                                    <input id="Op_Inc_Employer" type="text" class="form-control Op_Income_inputs" name="Op_Inc_Employer" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Op_is_Employed_Div" style="display: none;">
                                    <label for="Op_Inc_Employer_Payroll_Street_Address">Employer Street Address</label>
                                    <input id="Op_Inc_Employer_Payroll_Street_Address" type="text" class="form-control Op_Income_inputs" name="Op_Inc_Employer_Payroll_Street_Address" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Op_is_Employed_Div" style="display: none;">
                                    <label for="Op_Inc_Employer_Payroll_City_State_Zip">Employer City, State Zip</label>
                                    <input id="Op_Inc_Employer_Payroll_City_State_Zip" type="text" class="form-control Op_Income_inputs" name="Op_Inc_Employer_Payroll_City_State_Zip" value=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label>Wages Actual or Estimated?</label>
                                    <div class="w-100 dataInput">
                                         <label><input type="radio" id="Op_Wages_Actual_Actual" name="Op_Wages_Actual" value="Actual"> Actual</label>
                                         <label><input type="radio" id="Op_Wages_Actual_Estimated" name="Op_Wages_Actual" value="Estimated"> Estimated</label>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_RegWage_YTD_MinWage">Are wages regular/salary, irregular/seasonal, or minimum wage?</label>
                                    <select id="Op_RegWage_YTD_MinWage" name="Op_RegWage_YTD_MinWage" class="form-control Op_Income_inputs" onchange="onMinWageChange(this, 'Op');">
                                        <option value="1">Regular/salary</option>
                                        <option value="2">Irregular/seasonal</option>
                                        <option value="3">Minimum Wage</option>
                                    </select>   
                                ...
                                <div class="form-group col-sm-6 Op_RegWage_YTD_MinWage_Div Op_RegWage_YTD_MinWage_1_Div">
                                    ...
                                    <input id="Op_Wages_per_Period" type="number" class="form-control Op_Income_inputs" name="Op_Wages_per_Period" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="calculateBaseYearlyWagesByPerYear(this, 'Op');"> 
                                </div>
                                <div class="form-group col-sm-6 Op_RegWage_YTD_MinWage_Div Op_RegWage_YTD_MinWage_1_Div">
                                ...
                                <div class="form-group col-sm-6 Op_RegWage_YTD_MinWage_Div Op_RegWage_YTD_MinWage_2_Div" style="display: none;">
                                    ...
                                    <input id="Op_Pay_YTD" type="number" class="form-control Op_Income_inputs" name="Op_Pay_YTD" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="calculateBaseYearlyWagesByYTDPayDate(this, 'Op');"> 
                                </div>
                                <div class="form-group col-sm-6 Op_RegWage_YTD_MinWage_Div Op_RegWage_YTD_MinWage_2_Div" style="display: none;">
                                    <label for="Op_YTD_Date">YTD Pay Date</label>
                                    <input id="Op_YTD_Date" type="text" class="form-control hasDatepicker Op_Income_inputs" name="Op_YTD_Date" value="" onchange="calculateBaseYearlyWagesByYTDPayDate(this, 'Op');"> 
                                </div>
                                <div class="form-group col-sm-6 Op_RegWage_YTD_MinWage_3_Div Op_RegWage_YTD_MinWage_Base_Yearly_Wages_Div">
                                    ...
                                    <input id="Op_Base_Yearly_Wages" type="number" class="form-control Op_Income_inputs" name="Op_Base_Yearly_Wages" value="0.00" min="0.00" step="0.01" max="999999.99" readonly=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Last_Year_Base_Wages">Last Year Base Wages? (Yearly)</label>
                                    <input id="Op_Last_Year_Base_Wages" type="number" class="form-control Op_Income_inputs" name="Op_Last_Year_Base_Wages" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Year_Before_Last_Year_Base_Wages">Two Years Ago Base Wages (Yearly)?</label>
                                    <input id="Op_Year_Before_Last_Year_Base_Wages" type="number" class="form-control Op_Income_inputs" name="Op_Year_Before_Last_Year_Base_Wages" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Two_Years_Before_Last_Year_Base_Wages">Three Years Ago Base Wages (Yearly)?</label>
                                    <input id="Op_Two_Years_Before_Last_Year_Base_Wages" type="number" class="form-control Op_Income_inputs" name="Op_Two_Years_Before_Last_Year_Base_Wages" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Most_Recent_Yearly_OT_Comms_Bonuses">Last Year Overtime, Commissions, Bonuses, Etc. (Yearly)?</label>
                                    <input id="Op_Most_Recent_Yearly_OT_Comms_Bonuses" type="number" class="form-control Op_Income_inputs" name="Op_Most_Recent_Yearly_OT_Comms_Bonuses" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getMinAvgCommBonuses(this, 'Op');"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Second_Most_Recent_Yearly_OT_Comms_Bonuses">Two Years Ago Overtime, Commissions, Bonuses, Etc. (Yearly)?</label>
                                    <input id="Op_Second_Most_Recent_Yearly_OT_Comms_Bonuses" type="number" class="form-control Op_Income_inputs" name="Op_Second_Most_Recent_Yearly_OT_Comms_Bonuses" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getMinAvgCommBonuses(this, 'Op');"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Third_Most_Recent_Yearly_OT_Comms_Bonuses">Three Years Ago Overtime, Commissions, Bonuses, Etc. (Yearly)?</label>
                                    <input id="Op_Third_Most_Recent_Yearly_OT_Comms_Bonuses" type="number" class="form-control Op_Income_inputs" name="Op_Third_Most_Recent_Yearly_OT_Comms_Bonuses" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getMinAvgCommBonuses(this, 'Op');"> 
                                </div>
                                <div class="form-group col-sm-6" style="display: none;">
                                    <label for="Op_Min_Ave_OT_Comms_Bonuses">N/A = MIN(L24,(L24+L25+L26)/3)</label>
                                    <input id="Op_Min_Ave_OT_Comms_Bonuses" type="number" class="form-control Op_Income_inputs" name="Op_Min_Ave_OT_Comms_Bonuses" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Yearly_Unemployment_Compensation">Current Yearly Unemployment Compensation?</label>
                                    <input id="Op_Yearly_Unemployment_Compensation" type="number" class="form-control Op_Income_inputs" name="Op_Yearly_Unemployment_Compensation" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Yearly_Workers_Compensation">Current Yearly Workers’ Compensation?</label>
                                    <input id="Op_Yearly_Workers_Compensation" type="number" class="form-control Op_Income_inputs" name="Op_Yearly_Workers_Compensation" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Yearly_Social_Security_Disability">Current Yearly Social Security Disability?</label>
                                    <input id="Op_Yearly_Social_Security_Disability" type="number" class="form-control Op_Income_inputs" name="Op_Yearly_Social_Security_Disability" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Yearly_Other_Disability_Source">Source of Yearly Disability Income Other than Social Security?</label>
                                    <input id="Op_Yearly_Other_Disability_Source" type="text" class="form-control Op_Income_inputs" name="Op_Yearly_Other_Disability_Source" value=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Yearly_Other_Disability_Income">Current Yearly Income for Disability Other than Social Security?</label>
                                    <input id="Op_Yearly_Other_Disability_Income" type="number" class="form-control Op_Income_inputs" name="Op_Yearly_Other_Disability_Income" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Yearly_Social_Security_Retirement">Current Yearly Social Security Retirement Income?</label>
                                    <input id="Op_Yearly_Social_Security_Retirement" type="number" class="form-control Op_Income_inputs" name="Op_Yearly_Social_Security_Retirement" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Yearly_Gross_Self_Employment_Income">Current Yearly Gross Self-Employment Income?</label>
                                    <input id="Op_Yearly_Gross_Self_Employment_Income" type="number" class="form-control Op_Income_inputs" name="Op_Yearly_Gross_Self_Employment_Income" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Yearly_Self_Employment_Expenses">Current Yearly Self-Employment Expenses?</label>
                                    <input id="Op_Yearly_Self_Employment_Expenses" type="number" class="form-control Op_Income_inputs" name="Op_Yearly_Self_Employment_Expenses" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input id="Op_Yearly_Interest_Dividends" type="number" class="form-control Op_Income_inputs" name="Op_Yearly_Interest_Dividends" value="<?php if(isset($Op_Yearly_Interest_Dividends)){ echo $Op_Yearly_Interest_Dividends; } else { echo "0.00"; } ?>" step="0.01" max="999999.99" readonly=""> 
                                </div>
                                <div class="form-group col-sm-6" style="display: none;">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input id="Op_Monthly_Mandatory_Work_Deductions_NOT_TAXES_Type" type="text" class="form-control Op_Income_inputs" name="Op_Monthly_Mandatory_Work_Deductions_NOT_TAXES_Type" value=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    ...
                                    <input id="Op_Monthly_Mandatory_Work_Deductions_NOT_TAXES_Amt" type="number" class="form-control Op_Income_inputs" name="Op_Monthly_Mandatory_Work_Deductions_NOT_TAXES_Amt" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getYearlyDeduction(this, 'Op');"> 
                                </div>
                                <div class="form-group col-sm-6" style="display: none;">
                                    ...
                                    <input id="Op_Yearly_Mandatory_Work_Deductions_NOT_TAXES_Amt" type="number" class="form-control Op_Income_inputs" name="Op_Yearly_Mandatory_Work_Deductions_NOT_TAXES_Amt" value="0.00" min="0.00" step="0.01" max="999999.99" readonly=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Position">Work Position</label>
                                    <input id="Op_Position" type="text" class="form-control Op_Income_inputs" name="Op_Position" value=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Weekly_Hours">Work Hours per Week</label>
                                    <input id="Op_Weekly_Hours" type="number" class="form-control Op_Income_inputs" name="Op_Weekly_Hours" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Work_Phone">Work Phone</label>
                                    <input id="Op_Work_Phone" type="text" class="form-control Op_Income_inputs phone_input" name="Op_Work_Phone" value="" placeholder="(XXX) XXX-XXXX"> 
                                </div>
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input id="Op_Monthly_SSI" type="number" class="form-control Op_Income_inputs" name="Op_Monthly_SSI" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getYearlySSI(this, 'Op');">
                                </div>
                                <div class="form-group col-sm-6" style="display: none;">
                                    <label for="Op_Yearly_SSI">N/A, Calculated = 12*Op_Inc_Monthly_SSI</label>
                                    <input id="Op_Yearly_SSI" type="number" class="form-control Op_Income_inputs" name="Op_Yearly_SSI" value="0.00" min="0.00" step="0.01" max="999999.99" readonly=""> 
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="Op_Monthly_Public_Assistance_Amt">Amount of Monthly Public Assistance?</label>
                                    <input id="Op_Monthly_Public_Assistance_Amt" type="number" class="form-control Op_Income_inputs" name="Op_Monthly_Public_Assistance_Amt" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getYearlyPublicAssistanceAmt(this, 'Op');"> 
                                </div>
                                <div class="form-group col-sm-6" style="display: none;">
                                    <label for="Op_Yearly_Public_Assistance_Amt">N/A, Calculated = 12*Op_Inc_Monthly_Public_Assistance_Amt</label>
                                    <input id="Op_Yearly_Public_Assistance_Amt" type="number" class="form-control Op_Income_inputs" name="Op_Yearly_Public_Assistance_Amt" value="0.00" min="0.00" step="0.01" max="999999.99"> 
                                </div>
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="w-100 dataInput">
                                         <label><input type="checkbox" id="Op_Other_Source_Income" name="Op_Other_Source_Income" value="1" onchange="hasAnotherSourceOfIncome(this, 'Op');"> Yes</label>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Op_Other_Source_Name1" type="text" class="form-control Op_Income_inputs phone_input" name="Op_Other_Source_Name1" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Op_Other_Source_Zip1" type="text" class="form-control Op_Income_inputs 1_Op_Other_Income_inputs" name="Op_Other_Source_Zip1" value="" onkeyup="getCityStateForZip(this, '1_Op');"> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Street_Address1">Other Source of Income #1 Street Address?</label>
                                    <input id="Op_Other_Source_Street_Address1" type="text" class="form-control Op_Income_inputs 1_Op_Other_Income_inputs" name="Op_Other_Source_Street_Address1" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                ...
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Op_Other_Source_Acct_Num_or_Description1" type="text" class="form-control Op_Income_inputs 1_Op_Other_Income_inputs" name="Op_Other_Source_Acct_Num_or_Description1" value="">
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Yearly_Income1">Yearly Amount of Other Source of Income #1</label>
                                    <input id="Op_Other_Source_Yearly_Income1" type="number" class="form-control Op_Income_inputs" name="Op_Other_Source_Yearly_Income1" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getOtherYearlyIncomeTotal(this, 'Op');">
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Name2">Name of Other Source of Income #2</label>
                                    <input id="Op_Other_Source_Name2" type="text" class="form-control Op_Income_inputs phone_input" name="Op_Other_Source_Name2" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Op_Other_Source_Zip2" type="text" class="form-control Op_Income_inputs 2_Op_Other_Income_inputs" name="Op_Other_Source_Zip2" value="" onkeyup="getCityStateForZip(this, '2_Op');"> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Street_Address2">Other Source of Income #2 Street Address?</label>
                                    <input id="Op_Other_Source_Street_Address2" type="text" class="form-control Op_Income_inputs 2_Op_Other_Income_inputs" name="Op_Other_Source_Street_Address2" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                ...
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Op_Other_Source_Acct_Num_or_Description2" type="text" class="form-control Op_Income_inputs 2_Op_Other_Income_inputs" name="Op_Other_Source_Acct_Num_or_Description2" value="">
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Yearly_Income2">Yearly Amount of Other Source of Income #2</label>
                                    <input id="Op_Other_Source_Yearly_Income2" type="number" class="form-control Op_Income_inputs" name="Op_Other_Source_Yearly_Income2" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getOtherYearlyIncomeTotal(this, 'Op');"> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Name3">Name of Other Source of Income #3</label>
                                    <input id="Op_Other_Source_Name3" type="text" class="form-control Op_Income_inputs phone_input" name="Op_Other_Source_Name3" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Op_Other_Source_Zip3" type="text" class="form-control Op_Income_inputs 3_Op_Other_Income_inputs" name="Op_Other_Source_Zip3" value="" onkeyup="getCityStateForZip(this, '3_Op');"> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Street_Address3">Other Source of Income #3 Street Address?</label>
                                    <input id="Op_Other_Source_Street_Address3" type="text" class="form-control Op_Income_inputs 3_Op_Other_Income_inputs" name="Op_Other_Source_Street_Address3" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                ...
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Op_Other_Source_Acct_Num_or_Description3" type="text" class="form-control Op_Income_inputs 3_Op_Other_Income_inputs" name="Op_Other_Source_Acct_Num_or_Description3" value="">
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Yearly_Income3">Yearly Amount of Other Source of Income #3</label>
                                    <input id="Op_Other_Source_Yearly_Income3" type="number" class="form-control Op_Income_inputs" name="Op_Other_Source_Yearly_Income3" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getOtherYearlyIncomeTotal(this, 'Op');"> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Name4">Name of Other Source of Income #4</label>
                                    <input id="Op_Other_Source_Name4" type="text" class="form-control Op_Income_inputs phone_input" name="Op_Other_Source_Name4" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Op_Other_Source_Zip4" type="text" class="form-control Op_Income_inputs 4_Op_Other_Income_inputs" name="Op_Other_Source_Zip4" value="" onkeyup="getCityStateForZip(this, '4_Op');"> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Street_Address4">Other Source of Income #4 Street Address?</label>
                                    <input id="Op_Other_Source_Street_Address4" type="text" class="form-control Op_Income_inputs 4_Op_Other_Income_inputs" name="Op_Other_Source_Street_Address4" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                ...
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Op_Other_Source_Acct_Num_or_Description4" type="text" class="form-control Op_Income_inputs 4_Op_Other_Income_inputs" name="Op_Other_Source_Acct_Num_or_Description4" value="">
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Yearly_Income4">Yearly Amount of Other Source of Income #4</label>
                                    <input id="Op_Other_Source_Yearly_Income4" type="number" class="form-control Op_Income_inputs" name="Op_Other_Source_Yearly_Income4" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getOtherYearlyIncomeTotal(this, 'Op');"> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Name5">Name of Other Source of Income #5</label>
                                    <input id="Op_Other_Source_Name5" type="text" class="form-control Op_Income_inputs phone_input" name="Op_Other_Source_Name5" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Op_Other_Source_Zip5" type="text" class="form-control Op_Income_inputs 5_Op_Other_Income_inputs" name="Op_Other_Source_Zip5" value="" onkeyup="getCityStateForZip(this, '5_Op');"> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Street_Address5">Other Source of Income #5 Street Address?</label>
                                    <input id="Op_Other_Source_Street_Address5" type="text" class="form-control Op_Income_inputs 5_Op_Other_Income_inputs" name="Op_Other_Source_Street_Address5" value=""> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                ...
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    ...
                                    <input id="Op_Other_Source_Acct_Num_or_Description5" type="text" class="form-control Op_Income_inputs 5_Op_Other_Income_inputs" name="Op_Other_Source_Acct_Num_or_Description5" value="">
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Source_Yearly_Income5">Yearly Amount of Other Source of Income #5</label>
                                    <input id="Op_Other_Source_Yearly_Income5" type="number" class="form-control Op_Income_inputs" name="Op_Other_Source_Yearly_Income5" value="0.00" min="0.00" step="0.01" max="999999.99" onchange="getOtherYearlyIncomeTotal(this, 'Op');"> 
                                </div>
                                <div class="form-group col-sm-6 Op_Other_Source_Income_Div" style="display: none;">
                                    <label for="Op_Other_Yearly_Income_Total">Total Yearly Amount of Other Sources of Income</label>
                                    <input id="Op_Other_Yearly_Income_Total" type="number" class="form-control Op_Income_inputs" name="Op_Other_Yearly_Income_Total" value="0.00" min="0.00" step="0.01" max="999999.99" readonly=""> 
                                </div>
                            </div>
                        </div>
