...
<div class="container">
    <div class="row justify-content-center pleadings-main">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><strong>{{ __('Register New Subordinate Pleading #') }}{{$pleading_level}}</strong>
                ...
                <div class="card-body table-sm table-responsive">
                    ...
                    @endif
                      <form id="pleading_form" method="POST" action="{{route('cases.pleadings.subordinate.store')}}" autocomplete="off">
                          @csrf
                          <input type="hidden" name="case_id" value="{{$case_data->id}}">
                          <input type="hidden" name="parent_pleading_id" value="{{$pleading->id}}">
                            ...
                            <div class="check_all_filing_bottom_div">
                                ...
                                <div class="checkbox-options-outer four-option">
                                    @foreach ($bottom_party_data as $key => $party)
                                        <div class="check-box-options">
                                            <label class="label_filings_{{ $party->id }}"><input type="checkbox" class="right_filing all_filing_bottom all_filing_bottom_party" id="left_filing_{{ $party->id }}" name="filings[]" value="{{ $party->id }}" onchange="onFilingChange(this);" data-onload="onFilingChange(this);" data-user-name="{{ $party->name }}" data-user-type="bottom" data-user-party="{{$bottom_party_type}}" <?php if(isset($select_party_id) && $select_party_id==$party->id){ echo "checked"; } ?>> {{ $party->name }}</label>
                                        </div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                            ...
                            <div class="check_all_filing_third_div">
                                ...
                                <div class="checkbox-options-outer four-option">
                                    ...
                                    @foreach ($bottom_third_party_data as $key => $party)
                                        <div class="check-box-options">
                                            <label class="label_filings_{{ $party->id }}"><input type="checkbox" class="right_filing all_filing_third all_filing_third_party" id="left_filing_{{ $party->id }}" name="filings[]" value="{{ $party->id }}" onchange="onFilingChange(this);" data-onload="onFilingChange(this);" data-user-name="{{ $party->name }}" data-user-type="third" data-user-party="Third-Party {{$bottom_party_type}}" <?php if(isset($select_party_id) && $select_party_id==$party->id){ echo "checked"; } ?>> {{ $party->name }}</label>
                                        </div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                                        <div class="check-box-options" style="border-right:none;"></div>
...
<script type="text/javascript">
    ...
    function pleadingHasNewThirdparties(inputdata){
        if(inputdata.checked && inputdata.value=='Yes'){
            window.location.href = "{{ route('cases.pleadings.pleadinghasnewthirdparties',['case_id'=> $case_data->id, 'action' => 'sub_create', 'pleading_id' => 'sub_new'])}}";
        } else {
