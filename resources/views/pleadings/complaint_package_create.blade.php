...
<div class="container">
    <div class="row justify-content-center pleadings-main">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><strong>{{ __('Register New Pleading') }}</strong>
                ...
                <div class="card-body table-sm table-responsive">
                    ...
                    @endif
                      <form id="pleading_form" method="POST" action="{{route('cases.pleadings.store')}}" autocomplete="off">
                          @csrf
                          <input type="hidden" name="case_id" value="{{$case_data->id}}">
                          <input type="hidden" name="pleading_level" value="{{$pleading_level}}">
                          <input type="hidden" name="pleading_name" id="pleading_name" value="">
                        ...
                        <div class="form-group col-sm-12">
                            <div class="form-group col-sm-6">
                                ...
                                <input id="date_filed" type="text" class="form-control hasDatepicker" name="date_filed" value="{{ date('m/d/Y') }}" autocomplete="nope">
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="pleading_type_id" class="col-form-label text-md-left"><strong>Pleading Type</strong></label>
                                <select id="pleading_type_id" name="pleading_type_id" class="form-control" required="">
                                    <option value="">Select</option>
                                        <option value="{{$pleading_types[0]->id}}" selected="">{{$pleading_types[0]->type}}</option>
                                </select> 
                            </div>
                                ...
                                <div class="checkbox-options-outer four-option">
                                    @foreach ($top_party_data as $key => $party)
                                        <div class="check-box-options">
                                            <label class="label_filings_{{ $party->id }}"><input type="checkbox" class="filing_clients left_filings all_filing_top all_filing_top_party" id="left_filing_{{ $party->id }}" name="filings[]" value="{{ $party->id }}" onchange="onFilingChange(this);" required="" data-user-name="{{ $party->name }}" data-user-type="top" data-user-party="{{$top_party_type}}" checked=""> {{ $party->name }}</label>
                                        </div>
                            ...
                            <div class="check_all_filing_bottom_div">
                                ...
                                <div class="checkbox-options-outer four-option">
                                    @foreach ($bottom_party_data as $key => $party)
                                        <div class="check-box-options">
                                            <label class="label_filings_{{ $party->id }}"><input type="checkbox" class="right_filing all_filing_bottom all_filing_bottom_party" id="left_filing_{{ $party->id }}" name="filings[]" value="{{ $party->id }}" onchange="onFilingChange(this);" data-user-name="{{ $party->name }}" data-user-type="bottom" data-user-party="{{$bottom_party_type}}"> {{ $party->name }}</label>
                                        </div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                            ...
                            <div class="check_all_filing_third_div">
                                ...
                                <div class="checkbox-options-outer four-option">
                                    ...
                                    @foreach ($top_third_party_data as $key => $party)
                                        <div class="check-box-options">
                                            <label class="label_filings_{{ $party->id }}"><input type="checkbox" class="right_filing all_filing_third all_filing_third_party" id="left_filing_{{ $party->id }}" name="filings[]" value="{{ $party->id }}" onchange="onFilingChange(this);" data-user-name="{{ $party->name }}" data-user-type="third" data-user-party="Third-Party {{$top_party_type}}"> {{ $party->name }}</label>
                                        </div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                                    ...
                                    @foreach ($bottom_third_party_data as $key => $party)
                                        <div class="check-box-options">
                                            <label class="label_filings_{{ $party->id }}"><input type="checkbox" class="right_filing all_filing_third all_filing_third_party" id="left_filing_{{ $party->id }}" name="filings[]" value="{{ $party->id }}" onchange="onFilingChange(this);" data-user-name="{{ $party->name }}" data-user-type="third" data-user-party="Third-Party {{$bottom_party_type}}"> {{ $party->name }}</label>
                                        </div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                                        <div class="check-box-options" style="border-right:none;"></div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="radio" id="pleading_includes_claims_y" class="pleading_includes_claims_inputs" name="pleading_includes_claims" value="Yes" required="" checked="">
                            <label for="pleading_includes_claims_y">YES</label>
                            <input type="radio" id="pleading_includes_claims_n" class="pleading_includes_claims_inputs" name="pleading_includes_claims" value="No">
                        ...
                        <div class="form-group col-sm-12 responsible-parties-main">
                            ...
                            <div class="check_all_responsible_top_div">
                                ...
                                <div class="checkbox-options-outer four-option">
                                    @foreach ($top_party_data as $key => $party)
                                        ...
                                        <div class="check-box-options">
                                            <input id="service_date_{{ $party->id }}" type="text" class="form-control hasDatepicker service_deadline_inputs label_responsibles_{{ $party->id }}" name="service_date_{{ $party->id }}" data-party-id="{{$party->id}}" value="" autocomplete="nope">
                                        </div>
                                        <div class="check-box-options">
                                            <input id="initial_deadline_{{ $party->id }}" type="text" class="form-control hasDatepicker initial_deadline_inputs label_responsibles_{{ $party->id }}" name="initial_deadline_{{ $party->id }}" data-party-id="{{$party->id}}" value="" autocomplete="nope">
                                        </div>
                                        <div class="check-box-options">
                                            <input id="current_deadline_{{ $party->id }}" type="text" class="form-control hasDatepicker current_deadline_inputs label_responsibles_{{ $party->id }}" name="current_deadline_{{ $party->id }}" value="" autocomplete="nope">
                                        </div>
                                    @endforeach
                            ...
                            <div class="check_all_responsible_third_div">
                                ...
                                <div class="checkbox-options-outer four-option">
                                    ...
                                    @foreach ($bottom_third_party_data as $key => $party)
                                        <div class="check-box-options">
                                            <label class="label_responsibles_{{ $party->id }}"><input type="checkbox" class="right_responsible all_responsible_third all_responsible_third_party" id="right_responsible_{{ $party->id }}" name="responsibles[]" value="{{ $party->id }}" onchange="onResponsibleChange(this);" data-user-name="{{ $party->name }}" data-user-type="third" data-user-party="Third-Party {{$bottom_party_type}}"> {{ $party->name }}</label>
                                        </div>
                                        <div class="check-box-options">
                                            <input id="service_date_{{ $party->id }}" type="text" class="form-control hasDatepicker service_deadline_inputs label_responsibles_{{ $party->id }}" name="service_date_{{ $party->id }}" data-party-id="{{$party->id}}" value="" autocomplete="nope">
                                        </div>
...
<script type="text/javascript">
    ...
    function pleadingHasNewThirdparties(inputdata){
        if(inputdata.checked && inputdata.value=='Yes'){
            window.location.href = "{{ route('cases.pleadings.pleadinghasnewthirdparties',['case_id'=> $case_data->id, 'action' => 'create', 'pleading_id' => 'new'])}}";
        } else {
    ...
    $(document).ready(function(){
        ...
        // set service, initial and current dates
        var start_date=$('#date_filed').val();
        ...
        if(start_date){
            ...
            $.ajax({
                ...
                success: function(data){
                    if(data=='null' || data==''){
                        $('.initial_deadline_inputs, .current_deadline_inputs').val('');
                    } else {
                        ...
                        // $(".initial_deadline_inputs").datepicker("setDate", data);
                        // $(".current_deadline_inputs").datepicker("setDate", data);

                        var check=getPleadingName();
                        if(check){
                            $('#pleading_form').submit();
                        }
                    }
                }
            });   
