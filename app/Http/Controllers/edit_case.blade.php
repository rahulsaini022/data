                ...
                <div class="card-body">
                    ...
                    <form id="multistep_case_form" method="POST" action="{{route('cases.update_case',['id'=>$case_data->id])}}" autocomplete="off">
                        ...
                        <div class="row form-group">
                           ...
                           <p class="text-danger no-case-types" style="display: none;">No Cause(s) of Action found for this division.</p>
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(data['case_types']==null || data['case_types']=='null'){
                            ...
                            $('.case-types-div').append('<label class="col-md-12 case-type-main-label col-form-label text-md-left">Cause(s) of Action*</label>');
